 ...
 */
class Version20141017111018 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE bv_user (id INT AUTO_INCREMENT NOT NULL, msc_team_id INT DEFAULT NULL, fem_team_id INT DEFAULT NULL, mix_team_id INT DEFAULT NULL, username VARCHAR(255) NOT NULL, username_canonical VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, email_canonical VARCHAR(255) NOT NULL, enabled TINYINT(1) NOT NULL, salt VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, last_login DATETIME DEFAULT NULL, locked TINYINT(1) NOT NULL, expired TINYINT(1) NOT NULL, expires_at DATETIME DEFAULT NULL, confirmation_token VARCHAR(255) DEFAULT NULL, password_requested_at DATETIME DEFAULT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', credentials_expired TINYINT(1) NOT NULL, credentials_expire_at DATETIME DEFAULT NULL, gender VARCHAR(255) NOT NULL, dob DATETIME NOT NULL, address VARCHAR(512) NOT NULL, picture VARCHAR(255) NOT NULL, shirt_size VARCHAR(5) NOT NULL, is_required_bill TINYINT(1) NOT NULL, is_looking_for_team TINYINT(1) NOT NULL, level VARCHAR(255) NOT NULL, geo_lat VARCHAR(255) NOT NULL, geo_lng DOUBLE PRECISION NOT NULL, status VARCHAR(255) NOT NULL, licence_number VARCHAR(255) NOT NULL, fee_amount DOUBLE PRECISION NOT NULL, date_payment DATETIME NOT NULL, date_shirt_delivered DATETIME NOT NULL, UNIQUE INDEX UNIQ_4AAA3D2192FC23A8 (username_canonical), UNIQUE INDEX UNIQ_4AAA3D21A0D96FBF (email_canonical), UNIQUE INDEX UNIQ_4AAA3D21B0510F93 (msc_team_id), UNIQUE INDEX UNIQ_4AAA3D217102A2EA (fem_team_id), UNIQUE INDEX UNIQ_4AAA3D21AE48C21E (mix_team_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
